...
dnl #define IR(b,e) irange<std::common_type_t<decltype(b),decltype(e)>>(b,e)
dnl for C++11
dnl #define IR(b,e) irange<std::common_type<decltype(b),decltype(e)>::type>(b,e)
